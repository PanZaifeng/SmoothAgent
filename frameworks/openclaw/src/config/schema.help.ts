...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.compaction.softTriggerRatio":
    "Fraction of the live prompt/context budget that triggers background compaction lookahead before hard compaction is required. Lower values start lookahead earlier and reduce miss risk; default is 0.6.",
